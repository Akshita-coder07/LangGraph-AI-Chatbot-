...
•	Developed an Intelligent AI chatbot platform using LangGraph, supporting multiple LLM providers (Groq & OpenAI) with dynamic model switching and customizable agent behavior via system prompts.
